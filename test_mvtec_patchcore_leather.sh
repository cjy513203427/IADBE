...
config_file="./configs/models/patchcore.yaml"
# Path to the pre-trained model checkpoint
ckpt_path="/home/jinyao/PycharmProjects/IADBE/results/Patchcore/MVTec/leather/latest/weights/lightning/model.ckpt"
